...
Uwaga: TP-Link przy pierwszym logowaniu z fabrycznymi ustawieniami wymusza zmianę hasła. Jeśli nie daje się użyć loginu fabrycznego oznacza to, że wcześniej kroś ustawił swoje hasło. W takim przypaddku należy zresetować switch do ustawień fabrycznych (nacisnąć kilka sekund długopisem mikroprzycisk w małej dziurce na tylej ściance). **Fabryczny login to admin, hasło jest puste**. 
