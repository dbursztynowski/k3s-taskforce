...
UWAGA: skrypt shutubu.sh korzysta z ansible w trybie ad-hoc, a ten obecnie bazuje na pliku inventory/main.yaml. Plik ten obejmuje wszystkie malinki klastra - wszystkie są wyłączane tym skryptem. W przypadku zainstalowania ZeroTir na malince należy sporządzić odrębny plik inventory - bez raspberki hostującej ZeroTier (jej nie należy wyłączać, bo musi obsługiwać VPN podczas rebootowania TP-Link).
