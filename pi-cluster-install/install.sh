...
MASTER_NODE="k3s01"                   # adjust the name prefix to your settings, apply this format:
                                      #   <cluster_node_prefix><1> (here cluster_node_prefix is k3s0)
WORKER_GROUP="node"                   # Ansible group of nodes serving as agent/worker - check Ansible files to understand the structure
WORKER_NODE_PREF="k3s0"               # adjust worker node name prefix to your settings; for worker node name apply this format:
                                      #   <cluster_node_prefix><consecutive_integer> (consecutive_integer=2,3,4 so node names will be k3s02, ...)
