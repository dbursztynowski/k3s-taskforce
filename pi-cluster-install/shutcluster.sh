...
# https://docs.ansible.com/projects/ansible/latest/playbook_guide/playbooks_async.html#asynchronous-ad-hoc-tasks
#CLUSTER_INV="shutdown-hosts.ini"
CLUSTER_INV="inventory/hosts.ini"
ansible all -i $CLUSTER_INV -B 1 -P 0 -m shell -a "sleep 5 && shutdown now" --become
