The files contained in this direcotory serve to create an image of artificial workload container that can be used to generate variable load (mainly in terms of CPU usage) in Kubernetes cluster.
